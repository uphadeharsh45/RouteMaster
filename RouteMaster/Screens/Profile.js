    ...
    const fetchUserData = async () => {
      try {
        ...
        if (response.ok) {
          ...
          setName(name || '');  // Ensure name is not null or undefined
          setEmail(email || '');  // Ensure email is not null or undefined
          setGender(gender || '');  // Ensure gender is not null or undefined
          setMobile(mobile || '');  // Ensure mobile is not null or undefined
          setImage(image || '');  // Ensure image is not null or undefined
        } else {
